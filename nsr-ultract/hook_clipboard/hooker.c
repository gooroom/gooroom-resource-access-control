...
unsigned char *conf_path="/home/ultract/gooroom-resource-access-control/hook_clipboard/hooker.conf";

unsigned char *alert_msg_copy="Clipboard(copy) is disallowed!!";
unsigned char *alert_msg_paste="Clipboard(paste) is disallowed!!";
