...
unsigned char *conf_path="/home/ultract/gooroom-resource-access-control/hook_screenshooter/hooker.conf";

unsigned char *alert_msg="Screen Capture is disallowed!!";
